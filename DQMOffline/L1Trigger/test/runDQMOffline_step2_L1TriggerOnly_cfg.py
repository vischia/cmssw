...
process.DQMOffline_SecondStep_PreDPG.remove(process.HcalDQMOfflinePostProcessor)
...
process.DQMOffline_SecondStep_PrePOG.remove(process.bTagCollectorSequenceDATA)
